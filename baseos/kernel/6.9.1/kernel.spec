...
%define specrpmversion 6.9.1
%define specversion 6.9.1
%define patchversion 6.9
#%%define pkgrelease 51.vanilla
%define kversion 6
%define tarfile_release 6.9.1
# This is needed to do merge window version magic
%define patchlevel 9
# This allows pkg_release to have configurable %%{?dist} tag
#%%define specrelease 51%{?buildid}%{?dist}
# This defines the kabi tarball version
%define kabiversion 6.9.1
...
#
%changelog
* Fri May 17 2024 Thorsten Leemhuis <fedora@leemhuis.info> [6.9.1-51.vanilla]
- import ark-infra from ark-infra-stable-6.9 (04815b1198d) (Thorsten Leemhuis)
- Linux v6.9.1
