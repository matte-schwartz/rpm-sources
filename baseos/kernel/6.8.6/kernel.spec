...
Patch505: 0001-drm-amd-display-Separate-setting-and-programming-of-.patch
Patch506: 0002-drm-amd-display-Do-cursor-programming-with-rest-of-p.patch
Patch507: 0003-drm-amd-display-Use-separate-cursor-programming-if-n.patch
...
ApplyOptionalPatch 0001-drm-amd-display-Separate-setting-and-programming-of-.patch
ApplyOptionalPatch 0002-drm-amd-display-Do-cursor-programming-with-rest-of-p.patch
ApplyOptionalPatch 0003-drm-amd-display-Use-separate-cursor-programming-if-n.patch
